...
public class Mouse : MonoBehaviour {
    ...
    void Update() {
        if(! EventSystem.current.IsPointerOverGameObject()) {
            ...
            if(Input.GetMouseButtonDown(0) && SelectedTile != null && MouseX == SelectedTile.Data.x && MouseY == SelectedTile.Data.y)
                SelectedTile = null;
            else if(Input.GetMouseButtonDown(0) && MouseX >= 0 && MouseX < GeneralReference.r.Width && MouseY >= 0 && MouseY < GeneralReference.r.Height) {
